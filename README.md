...
```bash
# For development
terraform workspace select fresh-public-demo-airbyte-dev

# For staging
terraform workspace select fresh-public-demo-airbyte-stage
...
- Terraform workspace (`fresh-public-demo-airbyte-{env}`)
- Airbyte workspace
- BigQuery datasets
...
#### Workspace Not Found
```bash
Error: workspace "fresh-public-demo-airbyte-dev" does not exist
```
